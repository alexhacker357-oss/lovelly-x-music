...
class Config:
    def __init__(self):
        ...
        self.PING_IMG: str = getenv("PING_IMG", "https://files.catbox.moe/c8ozs3.jpeg")
        self.START_IMG: str = getenv("START_IMG", "https://files.catbox.moe/c8ozs3.jpeg")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://files.catbox.moe/c8ozs3.jpeg")
